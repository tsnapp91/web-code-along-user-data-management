...
function User(props) {
  ...
  return (
    <div>
      <h2 style={props.user.formatted}>Name: {props.user.profile.name !== undefined && props.user.profile.name !== '' ? props.user.profile.name : "undefined"}</h2>
      <h4 style={props.user.formatted}>About: {props.user.profile.about !== undefined && props.user.profile.about !== '' ? props.user.profile.about : "undefined"}</h4>
      <div>
      ...
      <div>
        <p style={props.user.formatted}>Role(s): {props.user.roles !== undefined && props.user.roles !== [] && props.user.roles !== '' ? props.user.roles.map((role) => <span>{role}, </span>) : "undefined"}</p>
      </div>
    </div>
  );
}
